...
using MediatorBuddy.Samples.Mvc.Features.UpdateWidget;
using MediatorBuddy.Samples.Mvc.FluentValidationExample;

namespace MediatorBuddy.Samples.Mvc.Features.Common
{
    /// <summary>
