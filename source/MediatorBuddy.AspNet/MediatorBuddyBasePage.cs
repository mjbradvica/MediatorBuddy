// <copyright file="MediatorBuddyBasePage.cs" company="Michael Bradvica LLC">
...
namespace MediatorBuddy.AspNet
{
    ...
    public abstract class MediatorBuddyBasePage<TViewModel> : MediatorBuddyPage
        where TViewModel : new()
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediatorBuddyBasePage{TViewModel}"/> class.
        /// </summary>
        ...
        protected MediatorBuddyBasePage(IMediator mediator, Func<RazorErrorWrapper, IActionResult?>? extraOptions = null, string errorPage = "/Error")
