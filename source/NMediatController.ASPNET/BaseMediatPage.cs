// <copyright file="BaseMediatPage.cs" company="Michael Bradvica LLC">
...
namespace NMediatController.ASPNET
{
    ...
    /// </summary>
    public abstract class BaseMediatPage : PageModel
    {
        private readonly string _errorPage;

        /// <summary>
        /// Initializes a new instance of the <see cref="BaseMediatPage"/> class.
        /// </summary>
        ...
        protected BaseMediatPage(IMediator mediator, string errorPage = "/Error")
        {
            Mediator = mediator;
