// <copyright file="MediatorBuddyBasePageTests.cs" company="Michael Bradvica LLC">
...
namespace MediatorBuddy.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class MediatorBuddyBasePageTests
    {
        private readonly TestPage _testPage;

        /// <summary>
        /// Initializes a new instance of the <see cref="MediatorBuddyBasePageTests"/> class.
        /// </summary>
        public MediatorBuddyBasePageTests()
        {
        ...
        private class TestPage : MediatorBuddyBasePage<TestResponse>
        {
